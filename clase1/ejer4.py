...
preferente. El programa debe preguntar al usuario por una opción 
del siguiente menú: (1) Añadir cliente, (2) Eliminar cliente, 
(3) Mostrar cliente, (4) Listar todos los clientes, 
(5) Listar clientes preferentes, (6) Terminar. En función de la opción
...
while opcion!='6':
    if opcion=='1':
        ...
        cliente= {'nombre': nombre, 'direccion': direccion, 'telefono': teléfono, 'correo': correo, 'preferente': preferente=="S"}
    ...
    if opcion=="2":
        ...
        if nif in clientes:
            ...
            print("No existe el cliente con ese NIF")
    if opcion=="3":
